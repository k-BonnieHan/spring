...
public class JikwonDto {
	...
	private String jikwon_no, jikwon_name, buser_name, jikwon_jik, jikwon_ibsa;
	private int count;
	...
	public String getJikwon_ibsa() {
		return jikwon_ibsa;
	}

	public void setJikwon_ibsa(String jikwon_ibsa) {
		this.jikwon_ibsa = jikwon_ibsa;
	}
